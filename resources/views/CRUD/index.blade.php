...
<body>
	<div class="navbar navbar-inverse">
		<div class="container-fluid">
			<a class="navbar-brand" href="{{URL::to('book/')}}">LaravelApp</a>
		    ...
		    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Agenda<span class="caret"></span></a>
				  <ul class="dropdown-menu" role="menu">
				    <li><a href="{{URL::to('agenda/create')}}">Registrar Contactos</a></li>
						<div class="divider">
						</div>
				    <li><a href="{{URL::to('agenda/')}}">Listar Contactos</a></li>
				  </ul>
		   </li>
				<li>
					<a href="#">Usuarios</a>
